...
def test_sub_hours():
    ...
    r = dt.sub_hours('2026-09-05 22:38:42', '2026-06-07 21:20:56')

    assert r == [{'fd': '2026-06-01', 'h': 554.65}, {'fd': '2026-09-01', 'h': 1606.65}]



   
def test_sub_hours_2():


    # r = dt.sub_hours2('2026-08-01 09:27:13', '2026-07-16 18:31:37')

    # assert r == [{'入场时间': '2026-07-01 00:00:00', '出场时间': '2026-07-31 23:59:59', 'h': 365.47}, {'入场时间': '2026-08-01 00:00:00', '出场时间': '2026-08-01 09:27:13', 'h': 9.45}]

    # r = dt.sub_hours2('2026-02-19 01:23:34', '2026-01-19 01:23:34')

    # assert r == [{'入场时间': '2026-01-01 00:00:00', '出场时间': '2026-01-31 23:59:59', 'h': 310.61}, {'入场时间': '2026-02-01 00:00:00', '出场时间': '2026-02-19 01:23:34', 'h': 433.39}]

    # r = dt.sub_hours2('2026-01-31 23:59:59','2026-01-31 12:09:46')


    # assert r == [{'入场时间': '2026-01-01 00:00:00', '出场时间': '2026-01-31 23:59:59', 'h': 11.84}]

    # r = dt.sub_hours2('2026-09-05 22:38:42', '2026-06-07 21:20:56')


    # assert r == [{'入场时间': '2026-06-01 00:00:00', '出场时间': '2026-06-30 23:59:59', 'h': 554.65}, 
    #              {'入场时间': '2026-07-01 00:00:00', '出场时间': '2026-07-31 23:59:59', 'h': 722.65},
    #             {'入场时间': '2026-08-01 00:00:00', '出场时间': '2026-08-31 23:59:59', 'h': 722.65},
    #                 {'入场时间': '2026-09-01 00:00:00', '出场时间': '2026-09-05 22:38:42', 'h':161.34}]

    r = dt.sub_hours2('2026-08-09 10:03:55','2026-07-26 17:14:19')
...
def test_seperate_date_into_months():
    ...
    r = dt.seperate_date_into_months(start_date='2026-06-07',end_date='2026-09-05')

    assert r == [['2026-06-07', '2026-06-30'], '2026-07-01', '2026-08-01', ['2026-09-01', '2026-09-05']]
